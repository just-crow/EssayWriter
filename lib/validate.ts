 ...
 * Orphan footnotes are repaired by pruneOrphanFootnotes (routes call it
 * right after generation), never by rejection. */
 ...
 * footnote entry are removed from the text. This is always safe: it only
 * deletes tokens, never prose. Returns the dropped footnote ids.
 */
